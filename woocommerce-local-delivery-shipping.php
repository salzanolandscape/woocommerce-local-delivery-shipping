...
{
	if( ! function_exists( 'change_string_shipping_may_be_available' ) )
	{
		/**
	...
	if( ! function_exists( 'change_string_shipping_not_available' ) )
	{
	...
	if( ! function_exists( 'change_string_shipping_suggestions' ) )
	{
		/**
	...
	if( ! function_exists( 'change_string_shipping_to_delivery' ) )
	{
		/**
	...
	if( ! function_exists( 'local_delivery_init' ) )
	{
	...
	if( ! function_exists( 'local_delivery_add_method' ) )
	{
